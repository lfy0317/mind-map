...
export type SettingOption = Mind.Options;
export namespace MindReact {
  ...
  export type Root = Mind.Root;

  export type TreeRoot = Mind.Root;
  ...
  export interface ViewProps {
    /**
     * 是否是受控组件
     * 默认是非受控组件（false），也就是说props.data的变化，不会引起脑图的re-render; 需要通过暴露的接口去控制
     */
    controlled?: boolean;
    /**
     *
