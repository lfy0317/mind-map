...
export namespace Mind {
  ...
  export interface Event {
     ...
     * @param e
     */
    onViewportContextMenu?: ClickEventHandle
    /**
     * zoom 事件触发器
     */
  ...
  export type ClickEventHandle = (e: MouseEvent, type: 'line' | 'node' | 'board', node?: Mind.Node) => void;
  ...
  export interface Options {
    ...
    size?: Size & Record<string, Size | number>
  }
